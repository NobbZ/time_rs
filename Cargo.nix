...
in {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".assert_fs."1.0.10" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "d94b2a3f3786ff2996a98afbd6b4e5b7e890d685ccf67577f508ee2342c71cc9";
    };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap."4.1.6" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "ec0b0588d44d4d63a87dbd75c136c166bbfd9a86a31cb89e09906521c7d3f5e3";
    };
    features = builtins.concatLists [
      ["cargo"]
      ["color"]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".figment."0.10.8" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "4e56602b469b2201400dec66a66aec5a9b8761ee97cd1b8c96ab2483fcc16cc9";
    };
    features = builtins.concatLists [
      ["env"]
      ["json"]
    ...
    dependencies = {
      ${
        ...
        rustPackages."registry+https://github.com/rust-lang/crates.io-index".atomic."0.5.1" {inherit profileName;};
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rstest_reuse."0.5.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCratesIo {
      inherit name version;
      sha256 = "45f80dcc84beab3a327bbe161f77db25f336a1452428176787c8c79ac79d7073";
    };
    dependencies = {
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.23" {inherit profileName;};
